...
if not st.session_state.clicked_yes:
    ...
    <div style="background: rgba(255, 255, 255, 0.15); padding: 25px; border-radius: 20px; border: 1px solid rgba(255,255,255,0.3); backdrop-filter: blur(10px); color: white; text-align: center; margin: 0 auto; width: 85%;">
        <span style="font-size: clamp(16px, 4vw, 20px); opacity: 0.9;">✨ <b>عيدكِ مبارك</b> ✨</span><br>
        <div style="font-size: clamp(22px, 7vw, 32px); font-weight: 900; color: #ffd700; text-shadow: 0 0 15px rgba(255, 215, 0, 0.5); margin: 15px 0;">
            كل عام وأنتِ عيدي🎀
        </div>
        <span style="font-size: clamp(18px, 5vw, 22px); font-weight: bold; color: #ffffff;">&lt;سجاد😊&gt;</span>
    </div>
    """, unsafe_allow_html=True)
